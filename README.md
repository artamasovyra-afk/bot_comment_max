...
Если канал уже был подключён к сервису другим администратором, повторная заявка не создаётся:
...
3. Бот проверит, что канал уже активен и что вы администратор этого канала в MAX.
4. После успешной проверки бот автоматически добавит вам доступ к `/admin` для этого канала.
