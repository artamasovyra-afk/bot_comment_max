...
12. Изображения в комментариях отображаются как компактные превью; при клике открывается полноэкранный просмотрщик, а несколько изображений показываются сеткой с навигацией.
