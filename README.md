...
2. Примите условия использования кнопкой `Принять и продолжить`.
...
10. Бэкенд валидирует подпись `initData`, сохраняет комментарий и, если у канала есть legacy-чат обсуждения, дублирует комментарий туда.
