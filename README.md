...
Сейчас проект использует только стандартную библиотеку Python и не требует сторонних пакетов из PyPI.

Файл [requirements.txt](/Users/urij/vscode/requirements.txt:1) всё равно добавлен в репозиторий, чтобы команда установки оставалась одинаковой на новой машине:

```bash
pip install -r requirements.txt
```

На текущий момент эта команда не ставит внешние библиотеки и просто фиксирует явный способ подготовки окружения.
